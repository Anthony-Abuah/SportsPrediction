        ...
        Row(modifier = Modifier.fillMaxWidth(),
            ...
            Row(modifier = Modifier.weight(1f),
                ...
                Box(modifier = Modifier
                    ...
                    .background(
                        color = getResultBackgroundColor(result),
                        shape = MaterialTheme.shapes.medium
                    ),
                    contentAlignment = Alignment.Center
                ){
                    Text(modifier = Modifier.padding(LocalSpacing.current.noPadding), text = getResult(result).first().toString().uppercase(), style = MaterialTheme.typography.h5)
                }
            }
