...
fun StatsTab(
    selectedIndex: Int,
    onSelect: (statTab: StatsTabs) -> Unit,
    ...
    TabRow(
        ...
        */
        ...
        Row(
            ...
            StatsTabs.values().forEachIndexed { index, statsTab ->
                ...
                Box(
                    modifier = Modifier
                        ...
                        .background(color = if (index == selectedIndex) Color.White else SelectedTabColor),
                    contentAlignment = Alignment.TopCenter
                ) {
                    Box(
                        modifier = Modifier
                        ...
                        Tab(selected = index == selectedIndex,
                            ...
                            onClick = { onSelect(statsTab) },
                            text = {
                                if (index == selectedIndex) SelectedTabText(text = statsTab.title)
                                    else UnselectedTabText(text = statsTab.title)
                            }
                        )
