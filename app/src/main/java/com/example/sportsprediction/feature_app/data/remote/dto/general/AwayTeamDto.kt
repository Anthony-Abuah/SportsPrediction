...
data class AwayTeamDto(
    ...
    fun toAwayTeamInfo(): TeamInfo {
        return TeamInfo(
            ...
            primaryTeamColors = teamColors?.primary?.trim() ?: emptyString,
            secondaryTeamColors = teamColors?.secondary?.trim() ?: emptyString,
            textTeamColors = teamColors?.text?.trim() ?: emptyString,
        )
    }
}